...
///REQUEST SOUND
    void request()
    {
        ...
        if(!sound_buffer_request.loadFromFile("C:\\Users\\Poizone\\CLionProjects\\APT_INFO\\sounds\\request.flac"))
            return;
        sf::Sound sound_request;
        sound_request.setBuffer(sound_buffer_request);
        sound_request.setVolume(10);
        sound_request.play();
...
///ONLINE SOUND
    void online()
    {
        ...
        if (!sound_buffer_online.loadFromFile("C:\\Users\\Poizone\\CLionProjects\\APT_INFO\\sounds\\online.flac"))
            return;
        sf::Sound sound_online;
        sound_online.setBuffer(sound_buffer_online);
        sound_online.setVolume(10);
        sound_online.play();
...
///OFFLINE SOUND
    void offline()
    {
        ...
        if (!sound_buffer_offline.loadFromFile("C:\\Users\\Poizone\\CLionProjects\\APT_INFO\\sounds\\offline.flac"))
            return;
        sf::Sound sound_offline;
        sound_offline.setBuffer(sound_buffer_offline);
        sound_offline.setVolume(10);
        sound_offline.play();
...
///Low current SOUND
    void low_current()
    {
        ...
        if (!sound_buffer.loadFromFile("C:\\Users\\Poizone\\CLionProjects\\APT_INFO\\sounds\\low_current.flac"))
            return;
        sf::Sound sound;
...
///Triggered_z SOUND
    ...
    {
        sf::SoundBuffer sound_buffer;
        if (!sound_buffer.loadFromFile("C:\\Users\\Poizone\\CLionProjects\\APT_INFO\\sounds\\triggered_z.flac"))
            return;
        sf::Sound sound;
        sound.setBuffer(sound_buffer);
        sound.setVolume(10);
